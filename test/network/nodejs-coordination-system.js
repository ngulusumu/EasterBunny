// Node.js compatible version of coordination-system.js
...
class NostrKeyManager {
    constructor(machineId = 'default') {
        // Use OS temp directory with unique machine ID
        this.keysPath = path.join(os.tmpdir(), `nostr-keys-${machineId}.json`);
        this.publicKey = null;
...
class MachineStatusManager {
    ...
    getMachineCapabilities() {
        return {
            ...
            cpus: os.cpus().length,
            memory: os.totalmem(),
            version: process.version // Use Node.js version instead of app version
        };
    }
...
class DecentralizedCoordinator {
    constructor(machineId = 'default') {
        this.keyManager = new NostrKeyManager(machineId);
